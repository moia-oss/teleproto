...
class OneOfWriterTest extends UnitTest {
  ...
  "Writer for one-of" should {
    ...
    implicit val fooOrBarWriter: Writer[model.FooOrBar, protobuf.FooOrBar] = {
      case foo: model.Foo => protobuf.FooOrBar(protobuf.FooOrBar.Value.Foo(transform[model.Foo, protobuf.Foo](foo)))
      case bar: model.Bar => protobuf.FooOrBar(protobuf.FooOrBar.Value.Bar(transform[model.Bar, protobuf.Bar](bar)))
    }
